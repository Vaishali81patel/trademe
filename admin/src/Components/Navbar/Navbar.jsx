    ...
    return (
        <div className='navbar'>
            <div className="nav-logo">
                <img src={logo} alt="Trademe" className='nav-logo'/>
            </div>
            <div class="dropdown">Browse
                ...
                <ul className="nav-menu">
                    ...
                    <li onClick={()=>{setmenu("listProduct")}}><Link style={{ textDecoration: 'none'}} to='/listProduct'>Favourites</Link>{menu==="listProduct"?<h/>:<></>}</li>
                    <li onClick={()=>{setmenu("addProduct")}}><Link style={{ textDecoration: 'none'}} to='/AddProduct'>Add Product</Link>{menu==="addProduct"?<h/>:<></>}</li>
